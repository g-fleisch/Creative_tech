...
var game = new Phaser.Game(320, 480, Phaser.AUTO, 'phaser-example', { preload: preload, create: create, update: update, render: render });
...
*/
 ...
 //   game.load.spritesheet('kaboom', 'assets/explode.png', 128, 128);
  ...
  /*  var invadeLoad = new Image();
    ...
    console.log(invadeLoad);
    game.cache.addSpriteSheet('invader', 'assets/invader32x32x4.png', invadeLoad, 32, 32, 4);
*/
 ...
 /*   var kaboomLoad = new Image();
    ...
    game.cache.addSpriteSheet('kaboom', 'assets/explode.png', kaboomLoad, 128, 128, 16);
*/
...
function createAliens () {
    ...
    var tween = game.add.tween(aliens).to( { x: 200 }, 1000, Phaser.Easing.Linear.None, true, 0, 500, true);
