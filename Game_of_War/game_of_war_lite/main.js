...
function init() {
    ...
    scene1preload.loadManifest(scene1manifest, true, "http://a.mnectar.com/uploads/8688/17562/");

    scene2preload = new createjs.LoadQueue(false);
    scene2preload.addEventListener("complete", handlescene2load);
    scene2preload.loadManifest(scene2Manifest, true, "http://a.mnectar.com/uploads/8688/17562/");

    scene3preload = new createjs.LoadQueue(false);
    scene3preload.addEventListener("complete", handlescene3load);
    scene3preload.loadManifest(scene3Manifest, true, "http://a.mnectar.com/uploads/8688/17562/");
    ...
    backgroundimg.src = "http://a.mnectar.com/uploads/8688/17562/gamePlay.jpg";
...
function handlescene1load(){
    ...
    */
    ...
    tutorialimg.src = "http://a.mnectar.com/uploads/8688/17562/barracksTextBox.png";
...
/*
    ...
    tutorialimg2.src = "http://a.mnectar.com/uploads/8688/17562/barracksTextBox.png";
